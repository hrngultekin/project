...
class ApplicationItem(QtWidgets.QListWidgetItem):
...
class ApplicationItemWidget(QtWidgets.QWidget, Ui_ApplicationItem):
...
class SummaryDialog(QtWidgets.QDialog, Ui_SummaryDialog):
